...
#ifndef MOSAIC_AUTO_CONFIGURER_CONFIG_READER_FACTORY_HPP
#define MOSAIC_AUTO_CONFIGURER_CONFIG_READER_FACTORY_HPP
...
#endif  // MOSAIC_AUTO_CONFIGURER_CONFIG_READER_FACTORY_HPP
