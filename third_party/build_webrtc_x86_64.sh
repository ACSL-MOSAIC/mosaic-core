...
gn gen out/Default --args='is_debug=false target_os="linux" target_cpu="x64" is_component_build=false rtc_include_tests=false use_custom_libcxx=false treat_warnings_as_errors=false use_ozone=true rtc_use_x11=false use_rtti=true rtc_build_examples=false rtc_build_json=false rtc_enable_protobuf=false'
